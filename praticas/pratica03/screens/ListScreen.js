...
function ListScreen() {
    return (
        <View style={styles.container}>
            ...
            <View style={styles.appBar}>
                <Text style={styles.appTitle}>Título do Item 1</Text>
                <Text style={styles.itemSubtitle}>Descrição breve do item 1.</Text>
            </View>
            <View style={styles.appBar}>
                <Text style={styles.appTitle}>Título do Item 2</Text>
                <Text style={styles.itemSubtitle}>Descrição breve do item 2.</Text>
            </View>
            <View style={styles.appBar}>
                <Text style={styles.appTitle}>Título do Item 3</Text>
                <Text style={styles.itemSubtitle}>Descrição breve do item 3.</Text>
            </View>
            <View style={styles.appBar}>
                <Text style={styles.appTitle}>Título do Item 4</Text>
